...
async function saveArticle(article) {
    ...
    try {
        const result = await client.query(`INSERT INTO blog_articles (slug, title, excerpt, content, read_time, status, source_urls)
       VALUES ($1, $2, $3, $4, $5, 'published', $6)
       RETURNING id`, [article.slug, article.title, article.excerpt, article.content, article.readTime, article.sourceUrls]);
